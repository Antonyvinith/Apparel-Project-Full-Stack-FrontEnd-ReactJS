...
function Profile() {
  ...
  //   // Make API call to fetch user image
  //   // Example:

  //   // fetch("http://localhost:9000/customer/profile-image",{
  //   //   headers: {
  ...
  //   // For demonstration purpose, setting user image from local storage
    
  //   // const imageUrlFromLocalStorage = localStorage.getItem("image");
  //   // setUserImage(imageUrlFromLocalStorage);
  ...
  return (
    <>
      ...
      <div className="profileContainer mt-2">
        <div className="menu">
          {/* <div className="userIcon" onClick={toggleModal}>
            <span>
              {userImage ? (
                <img
                  src={userImage}
                ...
                <div className="default-user-icon">User Icon</div>
              )}
            </span>
          </div> */}
          <div>
      ...
      {/* <Modal isOpen={modal} toggle={toggleModal}>
        <ModalHeader toggle={toggleModal}>Edit Profile Image</ModalHeader>
        <ModalBody>
