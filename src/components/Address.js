    ...
    axios
      ...
      .then((res) => {
        if (res.data) {
          ...
          onClose();
          setShippingAddress(res.data.responseData.line1);
          setShippingAddress(res.data.responseData.line2);
          setShippingAddress(res.data.responseData.city);
          setShippingAddress(res.data.responseData.state);
          setShippingAddress(res.data.responseData.country);
          setShippingAddress(res.data.responseData.pinCode);
