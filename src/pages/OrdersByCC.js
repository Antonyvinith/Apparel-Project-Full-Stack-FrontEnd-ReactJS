...
function OrdersByCC() {
    ...
    const loadOrders=async()=>{
        ...
        const result =await axios.get(`http://localhost:9000/order/CC?page=${currentPage}&size=${perPageData}`,{
            headers: {
    ...
    return (
        ...
        <div className='container'>
            <div className='py-'>
            <div><center><h1>Order List By CC</h1></center></div>
